...
export default class Signup extends Component {
    ...
    validate(text, type) {
        if (type == 'firstName') {
            ...
            let msg = this.getMatch(/^((\+92)|(0092))-{0,1}\d{3}-{0,1}\d{7}$|^\d{11}$|^\d{4}-\d{7}$/, text, "Correct format : xxxx xxxxxxx")
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: responsiveHeight(4) }}>
