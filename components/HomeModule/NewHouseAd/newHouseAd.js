...
import { uploadAdImage, getCurrentUid, deleteAdImage, getUserFirestoreObj } from '../../Utility/utility'
...
export default class NewHouseAd extends Component {
    ...
    getAdObj = uid => {
        let adObj = {
            ...
            'outletID': '', 'Category': 'Houses', 'Price': this.state.price, 'Location': this.state.location, 'Deliverable': false,
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <KeyboardAvoidingView style={{ flex: 9 }}>
                    <ScrollView>
                        <AdHeading fontSize={2.5} name={'For'} margin={responsiveHeight(2)} />
